...
export const MATRIX_GLOBE: MatrixCell[] = [
...

  {
    ...
    oracles: [{ kind: 'black_ratio', max: 0.03 }, { kind: 'finite_mvp' }],
    gate: 'soft',
    knownStatus: 'green',
...

  {
    ...
    surfaces: ['bg', 'fill', 'line'],
    camera: { center: [0, 20] },
    oracles: [{ kind: 'black_ratio', max: 0.05 }, { kind: 'finite_mvp' }],
    gate: 'soft',
    knownStatus: 'green',
...

  {
    ...
    surfaces: ['bg', 'fill'],
    camera: { center: [0, 89] },
    oracles: [{ kind: 'finite_mvp' }, { kind: 'black_ratio', max: 0.05 }],
    gate: 'soft',
    knownStatus: 'green',
...

  {
    ...
    surfaces: ['bg', 'fill'],
    camera: { center: [0, 90] },
    oracles: [{ kind: 'finite_mvp' }, { kind: 'black_ratio', max: 0.02 }],
    gate: 'soft',
    knownStatus: 'green',
