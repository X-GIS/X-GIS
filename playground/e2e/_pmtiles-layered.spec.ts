...
test('PMTiles layered: Tokyo z=14 paints water, land, roads, buildings distinctly', async ({
  page,
}) => {
  ...
  console.log(
    `[layered] water=${counts.waterBlue} land=${counts.landBeige} road=${counts.roadGrey} building=${counts.buildingMid}`,
  )
