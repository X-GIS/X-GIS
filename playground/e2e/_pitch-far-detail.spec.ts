...
const SCENARIOS: Scenario[] = [
  ...
  {
    label: 'bright pitch=0',
    url: '/demo.html?id=openfreemap_bright#15.0/35.68/139.76/0/0',
    viewport: { width: 390, height: 844 },
    expect: { zoom: 15, pitch: 0 },
  },
  {
    label: 'bright pitch=20',
    url: '/demo.html?id=openfreemap_bright#15.0/35.68/139.76/0/20',
    viewport: { width: 390, height: 844 },
    expect: { zoom: 15, pitch: 20 },
  },
  {
    label: 'bright pitch=30',
    url: '/demo.html?id=openfreemap_bright#15.0/35.68/139.76/0/30',
    viewport: { width: 390, height: 844 },
    expect: { zoom: 15, pitch: 30 },
  },
  {
    label: 'bright pitch=45',
    url: '/demo.html?id=openfreemap_bright#15.0/35.68/139.76/0/45',
    viewport: { width: 390, height: 844 },
    expect: { zoom: 15, pitch: 45 },
  },
  {
    label: 'bright pitch=60',
    url: '/demo.html?id=openfreemap_bright#15.0/35.68/139.76/0/60',
    viewport: { width: 390, height: 844 },
    expect: { zoom: 15, pitch: 60 },
  },
  {
    label: 'bright pitch=70',
    url: '/demo.html?id=openfreemap_bright#15.0/35.68/139.76/0/70',
    viewport: { width: 390, height: 844 },
    expect: { zoom: 15, pitch: 70 },
  },
  {
    label: 'bright pitch=80',
    url: '/demo.html?id=openfreemap_bright#15.0/35.68/139.76/0/80',
    viewport: { width: 390, height: 844 },
    expect: { zoom: 15, pitch: 80 },
  },
  // User's exact inspector report — desktop 1500×945, Seoul, z=14 pitch=73.2°.
  {
    label: 'desktop seoul pitch=73',
    url: '/demo.html?id=openfreemap_bright#14.0/37.54044/127.00441/75.0/73.2',
    viewport: { width: 1500, height: 945 },
    expect: { zoom: 14, pitch: 73 },
  },
]
  ...
  test(scn.label, async ({ page }) => {
    ...
    const result = await page.evaluate(() => {
      ...
      const buckets = {
        ...
        farground: tilesByDistance.filter((t) => t.dLat >= 0.05 && t.dLat < 0.2),
        horizon: tilesByDistance.filter((t) => t.dLat >= 0.2),
      }
