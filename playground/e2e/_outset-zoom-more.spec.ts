// Tighter zoom on stroke-outset NE corner to judge corner shape.
...
test('outset corner zoom more', async ({ page }) => {
  ...
  writeFileSync(join(ART, 'outset-NE-6x.png'), Buffer.from(cropped, 'base64'))
})
