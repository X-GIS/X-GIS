...
test('return-to-view determinism — same view renders the same after interaction', async ({
  page,
}) => {
  ...
  await page.goto('/debug-labels.html?style=openfreemap-bright#13/37.566/126.978', {
