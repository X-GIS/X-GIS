...
test('draw-stats probe — Bright + osm-style across views', async ({ page }) => {
  ...
  await probeView(
    page,
    'OFM Bright @ Seoul z=17 (worst case)',
    '/demo.html?id=openfreemap_bright#17.85/37.12665/126.92430',
  )
  await probeView(
    page,
    'OFM Bright @ Tokyo z=12 (typical)',
    '/demo.html?id=openfreemap_bright#12/35.68/139.76',
  )
  await probeView(
    page,
    'OFM Bright @ world z=3 (overview)',
    '/demo.html?id=openfreemap_bright#3/30/120',
  )
  await probeView(page, 'osm-style @ Tokyo z=14', '/demo.html?id=osm_style#14/35.68/139.76')
})
