...
| File                   | Description                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
| ---------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `web-entry.ts`         | Thin re-export of `registerXGISElement` and `XGISMap` from `@xgis/map`; used by the gallery `index.html` page.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
...
- `@xgis/map` — `XGISMap`, `registerXGISElement`, `lonLatToMercator`, `fetchPMTilesVectorLayerSchema`
