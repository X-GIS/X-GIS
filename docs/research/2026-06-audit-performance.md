...
*Deep-research synthesis, 2026-06-08. File:line audit of the X-GIS render-loop/budget/batching merged with GPU frame-budget and map-renderer performance research. Part of the 10-audit series. Claims cited inline.*
...
*Confidence: the codebase audit (direct read) and toji/web.dev/Mapbox/deck.gl primary sources are load-bearing. Hardware-specific numbers (7.5 ms upload, 100 ms compile, 60-frame convergence) are order-of-magnitude, device-dependent.*
