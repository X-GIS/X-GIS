// ═══ X-GIS Map Renderer — WGSL shader source ═══
//
// Behavior-preserving extraction of the inline WGSL shader-string
// constants from renderer.ts (string move only, byte-identical).
// renderer.ts re-exports these so its public surface is unchanged.
