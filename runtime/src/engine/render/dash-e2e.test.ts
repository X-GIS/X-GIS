...
import { packLineLayerUniform, LINE_CAP_BUTT, LINE_JOIN_MITER } from './line-renderer'
...
describe('end-to-end dash pipeline', () => {
  ...
  it('dense vertices: arc_start advances monotonically across segments', async () => {
    ...
    // compute.
    const { buildLineSegments, LINE_SEGMENT_STRIDE_F32 } = await import('./line-renderer')
