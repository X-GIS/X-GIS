// ═══ SDF Line Renderer — WGSL shader source ═══
//
// Behavior-preserving extraction of the inline WGSL shader-string
// constants from line-renderer.ts (string move only, byte-identical).
// line-renderer.ts re-exports LINE_SHADER_SOURCE so its public surface
// is unchanged.
