...
const UNIFORM_SIZE = 272 // bytes — matches VTR's reflected Uniforms struct (256 + 16 for the #600 globe_eye vec4)
// (the per-tile pack writes light_dir_ecef at f32 60-62 (#420) + globe_eye at f32 64-67 (#600))
