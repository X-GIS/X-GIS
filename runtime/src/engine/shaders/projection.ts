...
// is now EMITTED from `shader-dsl/projections.ts` — the SAME graph the cpu-f64
// lowering (`shader-dsl/cpu-projections.ts`, which replaced the deleted
...
//
// To change projection math, edit the DSL graph in `shader-dsl/projections.ts`
