...
| `f64`       | `number`       | `double`     | `f64`      | _(CPU only, GPU는 f32 다운캐스트)_ |
| `u8`        | `number`       | `uint8_t`    | `u8`       | `u32` _(패킹)_                     |
| `u32`       | `number`       | `uint32_t`   | `u32`      | `u32`                              |
| `vec2<f32>` | `Float32Array` | `glm::vec2`  | `[f32; 2]` | `vec2<f32>`                        |
| `vec2<f64>` | `Float64Array` | `glm::dvec2` | `[f64; 2]` | _(split to high+low f32)_          |
| `rgba`      | `Uint8Array`   | `uint32_t`   | `[u8; 4]`  | `vec4<f32>` _(normalize)_          |
