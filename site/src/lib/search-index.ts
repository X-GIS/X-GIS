...
import { galleryCategories } from '../content/gallery-demos'
...
function buildSearchIndex(base: string, posts: BlogPostRecord[]): SearchRecord[] {
  ...
  const anchorRecords: Array<{
    ...
    // /docs/functions
    {
      ...
      tag: 'Function',
      title: 'Math',
      body: 'clamp min max round floor ceil abs sqrt pow exp log log10 log2 scale',
    },
    {
      slug: 'trigonometry',
      page: 'functions',
      tag: 'Function',
      title: 'Trigonometry',
      body: 'sin cos tan asin acos atan atan2 radians degrees',
    },
    {
      slug: 'stops-gates',
      page: 'functions',
      tag: 'Function',
      title: 'Stops & gates — interpolate / step',
      body: 'interpolate step zoom feature property linear gate threshold',
    },
    {
      slug: 'constants',
      page: 'functions',
      tag: 'Function',
      title: 'Constants — PI / TAU',
      body: 'PI TAU pi tau radians',
    },
    {
      slug: 'array',
      page: 'functions',
      tag: 'Function',
      title: 'Array — length, [i] index',
      body: 'length array subscript index bracket',
    },
    {
      slug: 'geometry-generators',
      page: 'functions',
      tag: 'Function',
      title: 'Geometry generators — circle / arc / polygon / linestring',
      body: 'circle arc polygon linestring procedural geometry',
    },
    {
      slug: 'runtime-accessors',
      page: 'functions',
      tag: 'Function',
      title: 'Runtime accessors — zoom / .field',
      body: 'zoom field property accessor camera state',
    },
    // /docs/expressions
    {
      slug: 'operators',
    ...
    },
    {
      ...
      page: 'expressions',
      tag: 'Operator',
      title: 'Bracketed binding — utility-[expr]',
      body: 'utility binding expression bracket fill stroke opacity size data-driven',
    },
    {
      slug: 'match-block',
      page: 'expressions',
      tag: 'Operator',
      title: 'Match block — categorical lookup',
      body: 'match block categorical case lookup value mapping',
    },
    {
      slug: 'filter-predicate',
      page: 'expressions',
      tag: 'Operator',
      title: 'Filter predicate',
      body: 'filter predicate boolean layer feature',
    },
    {
      slug: 'field-modifier-conditional-fill',
      page: 'expressions',
      tag: 'Operator',
      title: 'Field-modifier conditional fill',
      body: 'modifier field property prefix conditional',
    },
    // /docs/sources
    {
      slug: 'geojson',
      page: 'sources',
      tag: 'Source',
      title: 'geojson — full file load',
      body: 'geojson source file URL load tiled',
    },
    {
      slug: 'pmtiles',
      page: 'sources',
      tag: 'Source',
      title: 'pmtiles — single archive',
      body: 'pmtiles archive byte-range MVT vector source-layer',
    },
    {
      slug: 'tilejson',
      page: 'sources',
      tag: 'Source',
      title: 'tilejson — XYZ MVT manifest',
      body: 'tilejson manifest XYZ MVT vector tile server openfreemap',
    },
    {
      slug: 'raster',
      page: 'sources',
      tag: 'Source',
      title: 'raster — XYZ tile server',
      body: 'raster XYZ tile server PNG JPG OSM basemap',
    },
    // /docs/cookbook
    {
      slug: '3d-buildings',
      ...
      body: 'fill-extrusion-height height render_height building 3d extrude',
    },
    {
      ...
      body: 'match continent category property fill color discrete',
    },
    {
      slug: 'zoom-fade',
      page: 'cookbook',
      ...
      body: 'zoom interpolate stroke width fade road',
    },
    {
    ...
    },
    {
      ...
      body: 'road casing stroke layer stack outline',
    },
    {
      slug: 'preset',
      page: 'cookbook',
      ...
      body: 'preset apply utility stack reuse',
    },
    {
      ...
      body: 'animation pulse keyframes opacity infinite',
    },
    {
      slug: 'filter-by-zoom',
      page: 'cookbook',
      ...
      body: 'minzoom maxzoom zoom threshold layer visibility',
    },
    {
      slug: 'mvt-layer-subset',
      page: 'cookbook',
      tag: 'Recipe',
      title: 'Restrict PMTiles decoding to source-layers',
      body: 'pmtiles layers subset mvt source-layer decode worker',
    },
    // /docs/mapbox
    {
      slug: 'mental-model',
      ...
      body: 'mapbox imperative declarative gl js maplibre',
    },
    {
      slug: 'converter',
      page: 'mapbox',
      ...
      body: 'convert style.json mapbox openfreemap import preset',
    },
    {
      slug: 'compatibility',
      page: 'mapbox',
      ...
      body: 'mapbox compatibility supported lossy unsupported symbol layer text',
    },
    {
      slug: 'expression-mapping',
      page: 'mapbox',
      tag: 'Mapbox',
      title: 'Expression mapping',
      body: 'mapbox expression interpolate match coalesce filter mapping',
    },
    {
      slug: 'caveats',
      page: 'mapbox',
      ...
      body: 'mapbox symbol cors curve roundtrip exponential',
    },
    ...
    // directly on the entry.
    {
      ...
      tag: 'API',
      title: 'Core',
      body: 'XGISMap run getCamera setProjection map class',
    },
    {
      slug: 'xgismap',
      page: 'api',
      tag: 'API',
      title: 'XGISMap',
      body: 'XGISMap class constructor canvas WebGPU',
    },
    {
      slug: 'xgismap-run',
      page: 'api',
      tag: 'API',
      title: 'XGISMap.run',
      body: 'run compile source baseUrl render loop',
    },
    {
      slug: 'xgismap-getcamera',
      page: 'api',
      tag: 'API',
      title: 'XGISMap.getCamera',
      body: 'getCamera live mutate lon lat zoom bearing pitch',
    },
    {
      slug: 'xgismap-setprojection',
      page: 'api',
      tag: 'API',
      title: 'XGISMap.setProjection',
      body: 'setProjection switch mercator orthographic uniform write',
    },
    {
      slug: 'camera',
      page: 'api',
      tag: 'API',
      title: 'Camera',
      body: 'Camera class lon lat zoom bearing pitch zoomAt MVP',
    },
    {
      slug: 'projections',
      page: 'api',
      tag: 'API',
      title: 'Projections',
      body: 'mercator equirectangular naturalEarth orthographic stereographic getProjection',
    },
    {
      slug: 'mercator',
      page: 'api',
      tag: 'API',
      title: 'mercator',
      body: 'Web Mercator EPSG 3857 default projection',
    },
    {
      ...
      body: 'plate carrée latitude direct y projection',
    },
    {
      slug: 'naturalearth',
      page: 'api',
      tag: 'API',
      title: 'naturalEarth',
      body: 'pseudo-cylindrical natural earth low-distortion',
    },
    {
      slug: 'orthographic',
      page: 'api',
      tag: 'API',
      title: 'orthographic',
      body: 'globe view orthographic hemispherical back-face cull',
    },
    {
      slug: 'getprojection',
      page: 'api',
      tag: 'API',
      title: 'getProjection',
      body: 'getProjection look up name args projection',
    },
    {
      slug: 'loaders',
      page: 'api',
      tag: 'API',
      title: 'Loaders',
      body: 'loadGeoJSON loadPMTilesSource attachPMTilesSource lonLatToMercator',
    },
    {
      slug: 'loadgeojson',
      page: 'api',
      tag: 'API',
      title: 'loadGeoJSON',
      body: 'loadGeoJSON fetch FeatureCollection auto-detect',
    },
    {
      slug: 'loadpmtilessource',
      page: 'api',
      tag: 'API',
      title: 'loadPMTilesSource',
      body: 'loadPMTilesSource streaming PMTiles backend header range',
    },
    {
      slug: 'attachpmtilessource',
      page: 'api',
      tag: 'API',
      title: 'attachPMTilesSource',
      body: 'attachPMTilesSource catalog source backend wire',
    },
    {
      slug: 'lonlattomercator',
      page: 'api',
      tag: 'API',
      title: 'lonLatToMercator',
      body: 'lonLatToMercator project coordinate web mercator meters',
    },
    {
      slug: 'gpu-compute',
      page: 'api',
      tag: 'API',
      title: 'GPU compute',
      body: 'ComputeDispatcher createColorRampTexture availableRamps WebGPU compute',
    },
    {
      slug: 'computedispatcher',
      page: 'api',
      tag: 'API',
      title: 'ComputeDispatcher',
      body: 'ComputeDispatcher WebGPU compute pipeline dispatch workgroups',
    },
    {
      slug: 'createcolorramptexture',
      page: 'api',
      tag: 'API',
      title: 'createColorRampTexture',
      body: 'color ramp texture viridis magma plasma 1d gradient',
    },
    {
      slug: 'availableramps',
      page: 'api',
      tag: 'API',
      title: 'availableRamps',
      body: 'availableRamps list color ramp names',
    },
    {
      slug: 'stats-diagnostics',
      page: 'api',
      tag: 'API',
      title: 'Stats + diagnostics',
      body: 'StatsPanel StatsTracker FPS draw call triangle',
    },
    {
      slug: 'statspanel',
      page: 'api',
      tag: 'API',
      title: 'StatsPanel',
      body: 'StatsPanel on-screen FPS draw call overlay',
    },
    {
      slug: 'statstracker',
      page: 'api',
      tag: 'API',
      title: 'StatsTracker',
      body: 'StatsTracker singleton frame stats',
    },
    {
      slug: 'custom-element',
      page: 'api',
      ...
      body: 'XGISMapElement registerXGISElement web components x-gis-map',
    },
    {
      slug: 'xgismapelement',
      page: 'api',
      tag: 'API',
      title: 'XGISMapElement',
      body: 'XGISMapElement custom element web component shadow root',
    },
    {
      slug: 'registerxgiselement',
      page: 'api',
      tag: 'API',
      title: 'registerXGISElement',
      body: 'register custom element x-gis-map global',
    },
  ]
