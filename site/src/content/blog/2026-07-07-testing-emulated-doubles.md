...
more than $2p + 2$ significand bits — Figueroa's classic *innocuous double
...
Each test asserts both halves: the df64 result lands within tolerance, *and*
...
The CPU oracle evaluates *authored* f64 natively — a JS number **is** an
...
Everything above runs the IR under *our* semantics. The failure mode fp64
...
1. S. A. Figueroa, ["When is Double Rounding
   Innocuous?"](https://dl.acm.org/doi/10.1145/221332.221334) *ACM SIGNUM
   Newsletter* 30(3) (1995), 21–26 — why binary64-then-binary32 rounding
