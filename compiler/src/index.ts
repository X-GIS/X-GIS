...
export type { Scene, SourceDef, RenderNode, ColorValue, StrokeValue, OpacityValue } from './ir/render-node'
export { hexToRgba, rgbaToHex, colorNone, colorConstant, opacityConstant } from './ir/render-node'
