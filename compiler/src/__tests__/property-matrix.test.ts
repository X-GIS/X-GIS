...
const NUMERIC_ZOOM_BEZIER = ['interpolate', ['cubic-bezier', 0.42, 0, 0.58, 1], ['zoom'], 5, 1, 15, 10]
...
const NUMERIC_DATA_BEZIER = ['interpolate', ['cubic-bezier', 0.25, 0.1, 0.25, 1], ['get', 'mag'], 0, 1, 10, 20]
...
const CELLS: MatrixCell[] = [
  ...
  { layerType: 'fill', property: 'fill-opacity',  valueForm: 'zoom-interp', value: NUMERIC_ZOOM_INTERP },
  ...
  { layerType: 'line', property: 'line-width',    valueForm: 'zoom-interp', value: NUMERIC_ZOOM_INTERP },
  { layerType: 'line', property: 'line-width',    valueForm: 'data-driven', value: NUMERIC_DATA_DRIVEN },
  { layerType: 'line', property: 'line-opacity',  valueForm: 'constant',    value: 0.5 },
  { layerType: 'line', property: 'line-opacity',  valueForm: 'zoom-interp', value: NUMERIC_ZOOM_INTERP },

  // circle
  { layerType: 'circle', property: 'circle-radius', valueForm: 'constant',    value: NUMERIC_CONSTANT },
  { layerType: 'circle', property: 'circle-radius', valueForm: 'zoom-interp', value: NUMERIC_ZOOM_INTERP },
  { layerType: 'circle', property: 'circle-radius', valueForm: 'data-driven', value: NUMERIC_DATA_DRIVEN },
  { layerType: 'circle', property: 'circle-color',  valueForm: 'constant',    value: COLOR_CONSTANT },
  { layerType: 'circle', property: 'circle-color',  valueForm: 'zoom-interp', value: COLOR_ZOOM_INTERP },
  { layerType: 'circle', property: 'circle-color',  valueForm: 'data-driven', value: COLOR_DATA_DRIVEN },

  // fill-extrusion
  { layerType: 'fill-extrusion', property: 'fill-extrusion-color',  valueForm: 'constant',    value: COLOR_CONSTANT },
  { layerType: 'fill-extrusion', property: 'fill-extrusion-color',  valueForm: 'zoom-interp', value: COLOR_ZOOM_INTERP },
  { layerType: 'fill-extrusion', property: 'fill-extrusion-height', valueForm: 'constant',    value: 10 },
  { layerType: 'fill-extrusion', property: 'fill-extrusion-height', valueForm: 'zoom-interp', value: NUMERIC_ZOOM_INTERP },
  { layerType: 'fill-extrusion', property: 'fill-extrusion-height', valueForm: 'data-driven', value: NUMERIC_DATA_DRIVEN },
  ...
  { layerType: 'line',   property: 'line-width', valueForm: 'zoom-interp', value: NUMERIC_ZOOM_BEZIER },
  { layerType: 'line',   property: 'line-width', valueForm: 'data-driven', value: NUMERIC_DATA_BEZIER },
...
describe('compiler property × value-form matrix', () => {
  for (const cell of CELLS) {
    it(`compiles ${cell.layerType}.${cell.property} (${cell.valueForm}) without dropping`, () => {
      ...
      expect(xgis.length, `${cell.layerType}.${cell.property} produced empty output`).toBeGreaterThan(50)
      ...
      const fatalWarn = coverage.warnings.find(w =>
        w.includes('failed to convert')
        || w.includes('Expression not converted')
        || w.includes('depth exceeded')
      )
      expect(fatalWarn, `${cell.layerType}.${cell.property} (${cell.valueForm}) fatal warning: ${fatalWarn ?? 'none'}`).toBeUndefined()
    })
  }
