...
const LAYOUT_SYMBOL: readonly CoverageEntry[] = [
  ...
  { name: 'icon-rotation-alignment', status: 'partial', impact: 'medium', note: '"viewport" (9 OFM layers) is X-GIS\' default icon render — already MapLibre-equivalent. "auto" on point placement same. "map" + symbol-placement=line (OFM road_oneway × 2) is a real gap — icon-along-line rotation needs symbol-placement=line support. Iter 494 suppressed false-positive warnings for the viewport/auto cases 2026-05-18.', source: 'layers.ts:1095' },
