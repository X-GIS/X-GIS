...
export const fillExtrusionCapabilities: readonly RuntimeCapability[] = [
  ...
  },
  {
    ...
    variant: 'zoom-interp',
    supported: true,
    note: 'WS-1 — routes through the fill-translate path; same per-frame resolve, applied in the extrude VS u.fill_translate.',
  },
  {
  ...
  },
  {
    ...
    variant: 'constant',
    supported: true,
    note: 'Phase 9 vertical gradient lighting honoured (commit 2026-05-18).',
  },
  ...
  // the wall_shade lighting in this Stage 2 cut (Stage 2.1 follow-up).
  {
    ...
    variant: 'constant',
    supported: true,
    note: 'Walls + roofs sample atlas via fs_fill_pattern; wall_shade lighting deferred to Stage 2.1',
  },
  {
    property: 'fill-extrusion-pattern',
    layerType: 'fill-extrusion',
