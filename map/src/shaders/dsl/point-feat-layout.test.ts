...
describe('POINT_FEAT layout spec', () => {
  ...
  it('style block [0, POINT_FEAT_STYLE_SLOTS) is exactly the Pass-0 verbatim-copy slots', () => {
    const style = [
      ...
      POINT_FEAT.slot.fill_r,
      POINT_FEAT.slot.fill_g,
      POINT_FEAT.slot.fill_b,
      POINT_FEAT.slot.fill_a,
      POINT_FEAT.slot.stroke_r,
      POINT_FEAT.slot.stroke_g,
      POINT_FEAT.slot.stroke_b,
      POINT_FEAT.slot.stroke_a,
  ...
  it('position slots sit above the style block (packer Pass-1 overwrite region)', () => {
    const position = [
      POINT_FEAT.slot.ecef_x_h,
      POINT_FEAT.slot.ecef_y_h,
      POINT_FEAT.slot.ecef_z_h,
      POINT_FEAT.slot.ecef_x_l,
      POINT_FEAT.slot.ecef_y_l,
      POINT_FEAT.slot.ecef_z_l,
      POINT_FEAT.slot.abs_lon,
      POINT_FEAT.slot.abs_lat,
      POINT_FEAT.slot.merc_x_h,
      POINT_FEAT.slot.merc_x_l,
      POINT_FEAT.slot.merc_y_h,
      POINT_FEAT.slot.merc_y_l,
    ]
