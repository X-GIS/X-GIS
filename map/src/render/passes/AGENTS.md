...
| `overdraw-compose-pass.ts` | Debug-only bucket: reads the `r16float` fragment-count accumulator and colourmap-composites it to the swapchain. Active only when the frame's `scene.overdraw` is set; runs last so it writes the final swapchain attachment.                                                                                                                                                                                                                                                                                                                                                                                                      |
