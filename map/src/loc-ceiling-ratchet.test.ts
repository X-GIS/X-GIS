...
const CEILINGS: Record<string, number> = {
  ...
  // 1524→1537 (#1635): the group(0) block's `_pad_tail0: vec4fT` becomes polygon's four
  ...
  'map/src/shaders/dsl/line.ts': 1537,
  ...
  // 1209→1214 (#1635): `writePointFrameUniform` packs the new `zoom` lane (point's Uniforms
  ...
  'map/src/render/point-renderer.ts': 1214,
