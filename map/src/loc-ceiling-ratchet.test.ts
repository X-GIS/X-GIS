...
const CEILINGS: Record<string, number> = {
  ...
  // +6, post-hook.
  // 5336→5337 (#1371): one line — the `getVtSource` SourceManager dep, so a data push can
  // swap a source's backend on the live catalog instead of tearing the pair down.
  'map/src/map.ts': 5337,
