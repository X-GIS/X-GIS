...
// (to 0 = delete the entry) in the same commit. Measured 2026-07-13 on the
// cast-audit branch. Ordered by path.
const BASELINE: Record<string, number> = {
  'blueprint/src/editor.ts': 3,
  'compiler/src/codegen/compute-output-binding.ts': 1,
  'compiler/src/convert/expand-color-match.ts': 2,
  'compiler/src/convert/mapbox-to-xgis.ts': 2,
  'compiler/src/ir/passes/merge-layers-helpers.ts': 8,
  'compiler/src/spec/oracle.ts': 2,
  'compiler/src/tiler/geojsonvt/clip.ts': 1,
  'compiler/src/tiler/geojsonvt/convert.ts': 2,
  'compiler/src/tiler/geojsonvt/tile.ts': 1,
  'compiler/src/tiler/geojsonvt/transform.ts': 3,
  'compiler/src/tiler/vector-tiler.ts': 1,
  'data/src/eval/extrude-eval.ts': 1,
  'data/src/eval/filter-eval.ts': 1,
  'data/src/geojson-helpers.ts': 1,
  'data/src/geojson.ts': 4,
  'data/src/sources/pmtiles-backend-helpers.ts': 2,
  'data/src/workers/geojson-compile-worker.ts': 5,
  'data/src/workers/geojson-tiling-worker.ts': 1,
  'data/src/workers/mvt-worker-pool.ts': 1,
  'data/src/workers/mvt-worker.ts': 6,
  'map/src/diagnostics.ts': 7,
  'map/src/feature-update-queue.ts': 1,
  'map/src/geojson-polar-cap-show.ts': 1,
  'map/src/layer.ts': 1,
  'map/src/map.ts': 13,
  'map/src/render-loop.ts': 7,
  'map/src/render/feature-data-binder.ts': 1,
  'map/src/render/heatmap-renderer.ts': 1,
  'map/src/render/line-renderer.ts': 1,
  'map/src/render/passes/label-pass.ts': 6,
  'map/src/render/pipeline-factory.ts': 1,
  'map/src/render/point-renderer.ts': 2,
  'map/src/render/projection-token.ts': 3,
  'map/src/render/tile-compute-resources.ts': 2,
  'map/src/render/tile-selection-cache.ts': 1,
  'map/src/render/vector-tile-renderer.ts': 2,
  'map/src/shaders/dsl/projections.ts': 2,
  'map/src/source-manager.ts': 10,
  'map/src/sprite/icon-renderer.ts': 1,
  'map/src/sprite/sprite-atlas-host.ts': 1,
  'map/src/stats.ts': 1,
  'map/src/text/format-value.ts': 1,
  'map/src/text/text-renderer.ts': 1,
  'map/src/text/text-resolver.ts': 1,
  'map/src/text/text-wrap.ts': 1,
  'rhi-webgpu/src/gpu-timer.ts': 1,
  'rhi-webgpu/src/gpu.ts': 2,
  'rhi-webgpu/src/rhi-webgpu.ts': 12,
  'shader-dsl/src/core/fp64/df64-lib.ts': 1,
  'shader-dsl/src/core/ir/builder.ts': 6,
  'shader-dsl/src/core/ir/node.ts': 1,
  'shader-dsl/src/core/oracle.ts': 1,
  'shader-dsl/src/core/sot.ts': 2,
